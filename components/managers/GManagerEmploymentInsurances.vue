 ...
 * @refact 2025-01-16
 */
import GDataTableEmploymentInsurances from '../atoms/tables/GDataTableEmploymentInsurances.vue'
import GBtnRegist from '../atoms/btns/GBtnRegist.vue'
import GInputEmploymentInsuranceV2 from '../molecules/inputs/GInputEmploymentInsuranceV2.vue'
...
<template>
  ...
  >
    ...
    <template #inputs="{ attrs, on }">
      <g-input-employment-insurance-v-2 v-bind="attrs" v-on="on" />
    </template>
  </air-array-manager>
</template>
