 ...
 * @refact 2025-01-16
 */
import GDataTableLeaveApplications from '../atoms/tables/GDataTableLeaveApplications.vue'
import GBtnRegist from '../atoms/btns/GBtnRegist.vue'
import GInputLeaveApplicationV2 from '../molecules/inputs/GInputLeaveApplicationV2.vue'
...
<template>
  ...
  >
    ...
    <template #inputs="{ attrs, on }">
      <g-input-leave-application-v-2 v-bind="attrs" v-on="on" />
    </template>
  </air-array-manager>
</template>
